...
export function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-950 dark:via-indigo-950 dark:to-gray-900">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <motion.div
          ...
          className="absolute -top-40 -right-40 w-96 h-96 bg-indigo-400/30 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            x: [0, 100, 0],
      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            Because apparently, long URLs are so 2010. Welcome to the future where links are shorter, smarter, and somehow make you feel more productive.
          </p>
          <div className="space-y-4 text-muted-foreground">
            <p className="text-sm">
              ✨ Shorten links like a boss (no actual bossing required)
            </p>
            <p className="text-sm">
              ✨ Track clicks that probably don't matter (but hey, data!)
            </p>
            <p className="text-sm">
              ✨ Feel important with your custom dashboard
            </p>
          </div>
        </motion.div>
          ...
          <Card className="backdrop-blur-xl bg-white/80 dark:bg-gray-900/80 border-2 shadow-2xl">
            <CardHeader className="space-y-3 text-center pb-6">
              ...
              <CardDescription className="text-base">
                Join us and start shortening those ridiculously long URLs.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <Button
                  type="submit"
                  className="w-full h-10 sm:h-12 text-sm sm:text-base font-semibold bg-black hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200"
                  disabled={isLoading}
                >
